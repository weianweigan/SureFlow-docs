...
export const DICTIONARY = {
  zh: {
    ...
    hero: {
      tag: '液压阀块三维设计桌面软件',
      title: '面向液压系统设计工程师的',
      titleHighlight: '阀块三维建模与孔道校验工具',
      description:
        'SureFlow 提供从外形定义、参数化孔腔库布孔、三维干涉与壁厚检查到工业格式导出的完整设计链路。支持多布局方案对比，内置 OpenCASCADE (OCCT) 几何内核直出标准 STEP 实体。',
      primaryAction: '下载 SureFlow 客户端',
      secondaryAction: '查阅使用文档',
      stats: {
        flow: '核心设计流程',
        flowVal: '定义/布孔/检查/导出',
        format: '标准工业格式',
        formatVal: 'STEP AP203/AP214',
        runtime: '客户端运行模式',
        runtimeVal: '桌面原生 / 离线可用',
      },
    },
    uiSection: {
      tag: '工作台实机视口',
  ...
  en: {
    ...
    hero: {
      tag: 'Hydraulic Manifold 3D Design Desktop Software',
      title: 'Engineered for Hydraulic Designers:',
      titleHighlight: '3D Manifold Modeling & Clearance Verification',
      description:
        'SureFlow delivers a unified workflow from block sizing, parametric cavity placement, and 3D clearance inspection to industrial format export. Supports multiple layout variants and exports standards-compliant STEP solids via OpenCASCADE (OCCT).',
      primaryAction: 'Download SureFlow Client',
      secondaryAction: 'View Documentation',
      stats: {
        flow: 'Core Workflow',
        flowVal: 'Define/Cavity/Check/Export',
        format: 'Industrial Standard',
        formatVal: 'STEP AP203/AP214',
        runtime: 'Client Architecture',
        runtimeVal: 'Desktop Native / Offline',
      },
    },
    uiSection: {
